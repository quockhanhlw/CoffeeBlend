...
@section('content')
    <div class="row">
        <div class="col">
          ...
          <form method="POST" action="{{ route('update.products.staff', $product->product_id) }}" enctype="multipart/form-data">
                @csrf
                ...
                <a href="{{ route('all.products.staff') }}" class="btn btn-secondary mb-4 ml-2">Cancel</a>
              </form>
