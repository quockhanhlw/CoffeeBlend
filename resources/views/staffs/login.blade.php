...
<head>
  ...
  <title>Staff Login - CoffeeBlend</title>
...
<body>
  <div class="login-container">
    ...
    <div class="login-right">
      <div class="login-header">
        <h2>Welcome Back!</h2>
        <p>Please login to access staff panel</p>
      </div>
      ...
      <form method="POST" action="{{ route('check.login.staff') }}" id="loginForm">
        @csrf
        ...
        <div class="form-group">
          ...
          <div class="input-wrapper">
            ...
            <button type="button" onclick="togglePassword()" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #11998e; font-size: 18px; z-index: 2;">
  ...
  // Check if page was loaded due to 419 error
